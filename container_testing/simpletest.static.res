...
sim: command line: /home/eugen/simplescalar-olga-arm-testing/sim-outorder -config simconfig/cache-trace-in.cfg -redir:sim simpletest.static.res simpletest.ss 

sim: simulation started @ Wed Jul 16 17:25:13 2008, options follow:
...
# -redir:sim     simpletest.static.res # redirect simulator output to file (non-interactive only)
...
sim_cycle                     31667 # total simulation time in cycles
sim_IPC                      0.4134 # instructions per cycle
sim_CPI                      2.4192 # cycles per instruction
sim_exec_BW                  0.6788 # total instructions (mis-spec + committed) per cycle
sim_IPB                      5.6618 # instruction per branch
IFQ_count                     20959 # cumulative IFQ occupancy
IFQ_fcount                    20959 # cumulative IFQ full count
ifq_occupancy                0.6619 # avg IFQ occupancy (insn's)
ifq_rate                     0.6788 # avg IFQ dispatch rate (insn/cycle)
ifq_latency                  0.9750 # avg IFQ occupant latency (cycle's)
ifq_full                     0.6619 # fraction of time (cycle's) IFQ was full
RUU_count                     59822 # cumulative RUU occupancy
RUU_fcount                        0 # cumulative RUU full count
ruu_occupancy                1.8891 # avg RUU occupancy (insn's)
ruu_rate                     0.6788 # avg RUU dispatch rate (insn/cycle)
ruu_latency                  2.7828 # avg RUU occupant latency (cycle's)
ruu_full                     0.0000 # fraction of time (cycle's) RUU was full
LSQ_count                     29096 # cumulative LSQ occupancy
LSQ_fcount                      343 # cumulative LSQ full count
lsq_occupancy                0.9188 # avg LSQ occupancy (insn's)
lsq_rate                     0.6788 # avg LSQ dispatch rate (insn/cycle)
lsq_latency                  1.3535 # avg LSQ occupant latency (cycle's)
lsq_full                     0.0108 # fraction of time (cycle's) LSQ was full
sim_slip                     110415 # total number of slip cycles
avg_sim_slip                 8.4351 # the average slip between issue and retirement
...
il1.accesses                  13837 # total number of accesses
il1.hits                      13465 # total number of hits
