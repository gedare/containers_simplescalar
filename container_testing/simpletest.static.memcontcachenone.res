...
sim: command line: sim-outorder -config simconfig/cache-trace-in-containercache.cfg -redir:sim simpletest.static.memcontcachenone.res simpletest.ss 

sim: simulation started @ Wed Jul 23 11:23:22 2008, options follow:
...
# -redir:sim     simpletest.static.memcontcachenone.res # redirect simulator output to file (non-interactive only)
...
-cache:cont_il1          none # l1 container permission cache config, i.e., {<config>|none}
...
sim_num_insn                  13144 # total number of instructions committed
sim_num_uops                  21576 # total number of UOPs executed
sim_avg_flowlen              1.6415 # uops per instruction
sim_num_refs                   5815 # total number of loads and stores committed
sim_num_loads                  3950 # total number of loads committed
sim_num_stores            1865.0000 # total number of stores committed
sim_num_branches               2324 # total number of branches committed
sim_elapsed_time                  1 # total simulation time in seconds
sim_inst_rate            13144.0000 # simulation speed (in insts/sec)
sim_total_insn                21575 # total number of instructions executed
sim_total_refs                 5815 # total number of loads and stores executed
sim_total_loads                3950 # total number of loads executed
sim_total_stores          1865.0000 # total number of stores executed
sim_total_branches             2324 # total number of branches executed
sim_cycle                     36872 # total simulation time in cycles
sim_IPC                      0.3565 # instructions per cycle
sim_CPI                      2.8052 # cycles per instruction
sim_exec_BW                  0.5851 # total instructions (mis-spec + committed) per cycle
sim_IPB                      5.6558 # instruction per branch
IFQ_count                     20988 # cumulative IFQ occupancy
IFQ_fcount                    20988 # cumulative IFQ full count
ifq_occupancy                0.5692 # avg IFQ occupancy (insn's)
ifq_rate                     0.5851 # avg IFQ dispatch rate (insn/cycle)
ifq_latency                  0.9728 # avg IFQ occupant latency (cycle's)
ifq_full                     0.5692 # fraction of time (cycle's) IFQ was full
RUU_count                     59527 # cumulative RUU occupancy
RUU_fcount                        0 # cumulative RUU full count
ruu_occupancy                1.6144 # avg RUU occupancy (insn's)
ruu_rate                     0.5851 # avg RUU dispatch rate (insn/cycle)
ruu_latency                  2.7591 # avg RUU occupant latency (cycle's)
ruu_full                     0.0000 # fraction of time (cycle's) RUU was full
LSQ_count                     28799 # cumulative LSQ occupancy
LSQ_fcount                      343 # cumulative LSQ full count
lsq_occupancy                0.7811 # avg LSQ occupancy (insn's)
lsq_rate                     0.5851 # avg LSQ dispatch rate (insn/cycle)
lsq_latency                  1.3348 # avg LSQ occupant latency (cycle's)
lsq_full                     0.0093 # fraction of time (cycle's) LSQ was full
sim_slip                     142941 # total number of slip cycles
avg_sim_slip                10.8750 # the average slip between issue and retirement
bpred_bimod.lookups            2335 # total number of bpred lookups
bpred_bimod.updates            2324 # total number of updates
bpred_bimod.addr_hits          1983 # total number of address-predicted hits
bpred_bimod.dir_hits           2089 # total number of direction-predicted hits (includes addr-hits)
...
bpred_bimod.bpred_addr_rate    0.8533 # branch address-prediction rate (i.e., addr-hits/updates)
bpred_bimod.bpred_dir_rate    0.8989 # branch direction-prediction rate (i.e., all-hits/updates)
...
il1.accesses                  13682 # total number of accesses
il1.hits                      13310 # total number of hits
...
dl1.accesses                   5810 # total number of accesses
dl1.hits                       5556 # total number of hits
dl1.misses                      254 # total number of misses
dl1.replacements                  0 # total number of replacements
dl1.writebacks                    0 # total number of writebacks
dl1.invalidations                 0 # total number of invalidations
dl1.miss_rate                0.0437 # miss rate (i.e., misses/ref)
dl1.repl_rate                0.0000 # replacement rate (i.e., repls/ref)
dl1.wb_rate                  0.0000 # writeback rate (i.e., wrbks/ref)
dl1.inv_rate                 0.0000 # invalidation rate (i.e., invs/ref)
itlb.accesses                 13682 # total number of accesses
itlb.hits                     13661 # total number of hits
...
dtlb.accesses                  5815 # total number of accesses
dtlb.hits                      5793 # total number of hits
...
mem.ptab_accesses            862826 # total page table accesses
