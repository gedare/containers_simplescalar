...
sim: command line: sim-outorder -config simconfig/cache-trace.cfg -redir:sim simpletest.base.res simpletest.ss 

sim: simulation started @ Tue Jul 15 14:15:41 2008, options follow:
...
# -redir:sim     simpletest.base.res # redirect simulator output to file (non-interactive only)
...
sim_num_insn                  13099 # total number of instructions committed
sim_num_uops                  21511 # total number of UOPs executed
sim_avg_flowlen              1.6422 # uops per instruction
sim_num_refs                   5805 # total number of loads and stores committed
sim_num_loads                  3940 # total number of loads committed
sim_num_stores            1865.0000 # total number of stores committed
sim_num_branches               2314 # total number of branches committed
sim_elapsed_time                  1 # total simulation time in seconds
sim_inst_rate            13099.0000 # simulation speed (in insts/sec)
sim_total_insn                21510 # total number of instructions executed
sim_total_refs                 5805 # total number of loads and stores executed
sim_total_loads                3940 # total number of loads executed
sim_total_stores          1865.0000 # total number of stores executed
sim_total_branches             2314 # total number of branches executed
sim_cycle                     31680 # total simulation time in cycles
sim_IPC                      0.4135 # instructions per cycle
sim_CPI                      2.4185 # cycles per instruction
sim_exec_BW                  0.6790 # total instructions (mis-spec + committed) per cycle
sim_IPB                      5.6608 # instruction per branch
IFQ_count                     20972 # cumulative IFQ occupancy
IFQ_fcount                    20972 # cumulative IFQ full count
ifq_occupancy                0.6620 # avg IFQ occupancy (insn's)
ifq_rate                     0.6790 # avg IFQ dispatch rate (insn/cycle)
ifq_latency                  0.9750 # avg IFQ occupant latency (cycle's)
ifq_full                     0.6620 # fraction of time (cycle's) IFQ was full
RUU_count                     59859 # cumulative RUU occupancy
RUU_fcount                        0 # cumulative RUU full count
ruu_occupancy                1.8895 # avg RUU occupancy (insn's)
ruu_rate                     0.6790 # avg RUU dispatch rate (insn/cycle)
ruu_latency                  2.7828 # avg RUU occupant latency (cycle's)
ruu_full                     0.0000 # fraction of time (cycle's) RUU was full
LSQ_count                     29104 # cumulative LSQ occupancy
LSQ_fcount                      343 # cumulative LSQ full count
lsq_occupancy                0.9187 # avg LSQ occupancy (insn's)
lsq_rate                     0.6790 # avg LSQ dispatch rate (insn/cycle)
lsq_latency                  1.3530 # avg LSQ occupant latency (cycle's)
lsq_full                     0.0108 # fraction of time (cycle's) LSQ was full
sim_slip                     110473 # total number of slip cycles
avg_sim_slip                 8.4337 # the average slip between issue and retirement
bpred_bimod.lookups            2325 # total number of bpred lookups
bpred_bimod.updates            2314 # total number of updates
bpred_bimod.addr_hits          1973 # total number of address-predicted hits
bpred_bimod.dir_hits           2079 # total number of direction-predicted hits (includes addr-hits)
...
bpred_bimod.bpred_addr_rate    0.8526 # branch address-prediction rate (i.e., addr-hits/updates)
...
il1.accesses                  13637 # total number of accesses
il1.hits                      13265 # total number of hits
...
dl1.accesses                   5800 # total number of accesses
dl1.hits                       5548 # total number of hits
...
itlb.accesses                 13637 # total number of accesses
itlb.hits                     13616 # total number of hits
...
dtlb.accesses                  5805 # total number of accesses
dtlb.hits                      5783 # total number of hits
...
mem.ptab_accesses            862578 # total page table accesses
