...
sim: command line: sim-outorder -config simconfig/cache-trace-in-containercache.cfg -redir:sim simpletest.static.memcontcachenone.heap.res simpletest.ss.nop 

sim: simulation started @ Wed Jul 23 11:27:02 2008, options follow:
...
# -redir:sim     simpletest.static.memcontcachenone.heap.res # redirect simulator output to file (non-interactive only)
...
sim_num_insn                  13290 # total number of instructions committed
sim_num_uops                  21723 # total number of UOPs executed
sim_avg_flowlen              1.6345 # uops per instruction
sim_num_refs                   5816 # total number of loads and stores committed
sim_num_loads                  3951 # total number of loads committed
sim_num_stores            1865.0000 # total number of stores committed
sim_num_branches               2326 # total number of branches committed
sim_elapsed_time                  1 # total simulation time in seconds
sim_inst_rate            13290.0000 # simulation speed (in insts/sec)
sim_total_insn                21722 # total number of instructions executed
sim_total_refs                 5816 # total number of loads and stores executed
sim_total_loads                3951 # total number of loads executed
sim_total_stores          1865.0000 # total number of stores executed
sim_total_branches             2326 # total number of branches executed
sim_cycle                     37079 # total simulation time in cycles
sim_IPC                      0.3584 # instructions per cycle
sim_CPI                      2.7900 # cycles per instruction
sim_exec_BW                  0.5858 # total instructions (mis-spec + committed) per cycle
sim_IPB                      5.7137 # instruction per branch
IFQ_count                     21153 # cumulative IFQ occupancy
IFQ_fcount                    21153 # cumulative IFQ full count
ifq_occupancy                0.5705 # avg IFQ occupancy (insn's)
ifq_rate                     0.5858 # avg IFQ dispatch rate (insn/cycle)
ifq_latency                  0.9738 # avg IFQ occupant latency (cycle's)
ifq_full                     0.5705 # fraction of time (cycle's) IFQ was full
RUU_count                     59899 # cumulative RUU occupancy
RUU_fcount                        0 # cumulative RUU full count
ruu_occupancy                1.6154 # avg RUU occupancy (insn's)
ruu_rate                     0.5858 # avg RUU dispatch rate (insn/cycle)
ruu_latency                  2.7575 # avg RUU occupant latency (cycle's)
ruu_full                     0.0000 # fraction of time (cycle's) RUU was full
LSQ_count                     28750 # cumulative LSQ occupancy
LSQ_fcount                      344 # cumulative LSQ full count
lsq_occupancy                0.7754 # avg LSQ occupancy (insn's)
lsq_rate                     0.5858 # avg LSQ dispatch rate (insn/cycle)
lsq_latency                  1.3235 # avg LSQ occupant latency (cycle's)
lsq_full                     0.0093 # fraction of time (cycle's) LSQ was full
sim_slip                     143073 # total number of slip cycles
avg_sim_slip                10.7655 # the average slip between issue and retirement
bpred_bimod.lookups            2336 # total number of bpred lookups
bpred_bimod.updates            2326 # total number of updates
bpred_bimod.addr_hits          1985 # total number of address-predicted hits
bpred_bimod.dir_hits           2088 # total number of direction-predicted hits (includes addr-hits)
...
bpred_bimod.bpred_addr_rate    0.8534 # branch address-prediction rate (i.e., addr-hits/updates)
bpred_bimod.bpred_dir_rate    0.8977 # branch direction-prediction rate (i.e., all-hits/updates)
...
il1.accesses                  13839 # total number of accesses
il1.hits                      13462 # total number of hits
...
dl1.accesses                   5811 # total number of accesses
dl1.hits                       5561 # total number of hits
dl1.misses                      250 # total number of misses
...
itlb.accesses                 13839 # total number of accesses
itlb.hits                     13817 # total number of hits
...
dtlb.accesses                  5816 # total number of accesses
dtlb.hits                      5794 # total number of hits
...
mem.ptab_accesses            863508 # total page table accesses
